...

{
    ...
    "category": "section",
    "text": "Once the oracle solver function defined, we assign it to some subproblems using the following function.addoracletosp!In our example, we dofor m in data.machines\n    addoracletosp!(gap, m, myKnapsackSolver)\nend"
},
...

{
    ...
    "category": "section",
    "text": "branchingpriorityinmasterbranchingpriorityinsubproblem"
},
...

{
    ...
    "category": "section",
    "text": "BlockDecomposition.BlockSolverInterface.set_oracles!BlockDecomposition.BlockSolverInterface.set_sp_mult!BlockDecomposition.BlockSolverInterface.set_sp_prio!BlockDecomposition.BlockSolverInterface.set_var_branching_prio!"
},
